...
| DOCUMENT_GENERATOR_SERVICE_URI                                                         | API URI of service (used in links, in emails) e.g. `http://localhost:3006/api`                   |
| SFD_MESSAGING_PROXY_SERVICE_URI                                                        | API URI of service (used in links, in emails) e.g. `http://localhost:3007/api`                   |
