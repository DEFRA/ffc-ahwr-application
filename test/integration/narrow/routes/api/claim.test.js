...
describe('Post claim test', () => {
  ...
  test('called with default value for amount ', async () => {
    const options = {
      method: 'POST',
      url: '/api/claim',
      payload: { ...claim }
  ...
  test('contain corresponding values ', async () => {
    const options = {
      method: 'POST',
      url: '/api/claim',
      payload: { ...claim }
  ...
  test('send email with values available ', async () => {
    ...
    const mockEmailDataWithoutAmount = {
      reference: 'AHWR-0F5D-4A26',
      email: 'test@test-unit.com',
    ...
    await sendEmail.sendFarmerEndemicsClaimConfirmationEmail(mockEmailDataWithoutAmount)
  ...
  test('no sendEmail when claim is false ', async () => {
    const options = {
      method: 'POST',
      url: '/api/claim',
      payload: {
